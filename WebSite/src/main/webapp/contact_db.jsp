...
<sql:query var="rs" dataSource="${db }">SELECT * FROM database_1.contact</sql:query>
<table border=2 style="margin-left:10rem;">
	...
	<tr>
	 	...
	 	<td style="padding:5px;"><c:out value="${ele.name}"></c:out></td>
	 	<td style="padding:5px;"><c:out value="${ele.email}"></c:out></td>
	 	<td style="padding:5px;"><c:out value="${ele.subject}"></c:out></td>
	 	<td style="padding:5px;"><c:out value="${ele.message}"></c:out></td>
	</tr>
	</c:forEach>
</table>
